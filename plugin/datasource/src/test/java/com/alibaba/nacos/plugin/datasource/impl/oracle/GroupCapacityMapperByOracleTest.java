...
public class GroupCapacityMapperByOracleTest {
    ...
    public void testSelectGroupInfoBySize() {
        ...
        Assert.assertEquals(mapperResult.getSql(), "SELECT * FROM (SELECT id, group_id, ROWNUM as rnum FROM group_capacity WHERE id > ?) WHERE rnum <= ?");
