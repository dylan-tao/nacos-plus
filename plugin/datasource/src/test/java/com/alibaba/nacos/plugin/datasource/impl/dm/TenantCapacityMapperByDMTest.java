...
public class TenantCapacityMapperByDMTest {
    ...
    private TenantCapacityMapperByDM tenantCapacityMapperByDM;
    ...
    public void setUp() throws Exception {
        tenantCapacityMapperByDM = new TenantCapacityMapperByDM();
    ...
    public void testGetTableName() {
        String tableName = tenantCapacityMapperByDM.getTableName();
        Assert.assertEquals(tableName, TableConstant.TENANT_CAPACITY);
    }
    
    @Test
    public void testGetDataSource() {
        String dataSource = tenantCapacityMapperByDM.getDataSource();
        Assert.assertEquals(dataSource, DataSourceConstant.DM);
    }
    
    @Test
    public void testIncrementUsageWithDefaultQuotaLimit() {
        MapperResult mapperResult = tenantCapacityMapperByDM.incrementUsageWithDefaultQuotaLimit(context);
    ...
    public void testIncrementUsageWithQuotaLimit() {
        MapperResult mapperResult = tenantCapacityMapperByDM.incrementUsageWithQuotaLimit(context);
        Assert.assertEquals(mapperResult.getSql(),
                "UPDATE tenant_capacity SET usage = usage + 1, gmt_modified = ? WHERE tenant_id = ? AND usage < "
                        + "quota AND quota != 0");
    ...
    public void testIncrementUsage() {
        MapperResult mapperResult = tenantCapacityMapperByDM.incrementUsage(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testDecrementUsage() {
        MapperResult mapperResult = tenantCapacityMapperByDM.decrementUsage(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testCorrectUsage() {
        MapperResult mapperResult = tenantCapacityMapperByDM.correctUsage(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testGetCapacityList4CorrectUsage() {
        ...
        MapperResult mapperResult = tenantCapacityMapperByDM.getCapacityList4CorrectUsage(context);
    ...
    public void testInsertTenantCapacity() {
        ...
        MapperResult mapperResult = tenantCapacityMapperByDM.insertTenantCapacity(context);
        Assert.assertEquals(mapperResult.getSql(),
