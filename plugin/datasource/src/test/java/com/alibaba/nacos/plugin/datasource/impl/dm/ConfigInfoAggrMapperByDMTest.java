...
public class ConfigInfoAggrMapperByDMTest {
    ...
    private ConfigInfoAggrMapperByDM configInfoAggrMapperByDM;
    
    @Before
    public void setUp() throws Exception {
        configInfoAggrMapperByDM = new ConfigInfoAggrMapperByDM();
    }
    ...
    public void testBatchRemoveAggr() {
        ...
        MapperResult mapperResult = configInfoAggrMapperByDM.batchRemoveAggr(context);
    ...
    public void testAggrConfigInfoCount() {
        ...
        context.putWhereParameter(FieldConstant.GROUP_ID, groupId);
        context.putWhereParameter(FieldConstant.TENANT_ID, tenantId);
        MapperResult mapperResult = configInfoAggrMapperByDM.aggrConfigInfoCount(context);
        String sql = mapperResult.getSql();
        List<Object> paramList = mapperResult.getParamList();
    ...
    public void testFindConfigInfoAggrIsOrdered() {
        ...
        MapperResult mapperResult = configInfoAggrMapperByDM.findConfigInfoAggrIsOrdered(context);
        String sql = mapperResult.getSql();
        List<Object> paramList = mapperResult.getParamList();
    ...
    public void testFindConfigInfoAggrByPageFetchRows() {
        ...
        MapperResult mapperResult = configInfoAggrMapperByDM.findConfigInfoAggrByPageFetchRows(context);
        String sql = mapperResult.getSql();
        List<Object> paramList = mapperResult.getParamList();
    ...
    public void testFindAllAggrGroupByDistinct() {
        MapperResult mapperResult = configInfoAggrMapperByDM.findAllAggrGroupByDistinct(null);
    ...
    public void testGetTableName() {
        String tableName = configInfoAggrMapperByDM.getTableName();
        Assert.assertEquals(tableName, TableConstant.CONFIG_INFO_AGGR);
    }
    
    @Test
    public void testGetDataSource() {
        String dataSource = configInfoAggrMapperByDM.getDataSource();
