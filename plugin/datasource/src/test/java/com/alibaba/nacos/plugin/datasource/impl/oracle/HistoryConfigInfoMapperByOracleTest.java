...
public class HistoryConfigInfoMapperByOracleTest {
    ...
    public void testRemoveConfigHistory() {
        ...
        Assert.assertEquals(mapperResult.getSql(), "DELETE FROM his_config_info WHERE gmt_modified < ? AND ROWNUM <= ?");
    ...
    public void testFindConfigHistoryCountByTime() {
        MapperResult mapperResult = historyConfigInfoMapperByOracle.findConfigHistoryCountByTime(context);
    ...
    public void testFindDeletedConfig() {
        ...
        Assert.assertEquals(mapperResult.getSql(),
                "SELECT * FROM (SELECT data_id, group_id, tenant_id,gmt_modified,nid,ROWNUM as rnum FROM his_config_info WHERE op_type = 'D' AND gmt_modified >= ? and nid > ? ORDER BY nid) WHERE rnum <= ? ");
    ...
    public void testFindConfigHistoryFetchRows() {
        ...
        context.putWhereParameter(FieldConstant.DATA_ID, dataId);
        MapperResult mapperResult = historyConfigInfoMapperByOracle.findConfigHistoryFetchRows(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testDetailPreviousConfigHistory() {
        ...
        MapperResult mapperResult = historyConfigInfoMapperByOracle.detailPreviousConfigHistory(context);
        Assert.assertEquals(mapperResult.getSql(),
