...
public class ConfigInfoTagMapperByDMTest {
    ...
    private ConfigInfoTagMapperByDM configInfoTagMapperByDM;
    ...
    public void setUp() throws Exception {
        configInfoTagMapperByDM = new ConfigInfoTagMapperByDM();
    ...
    public void testUpdateConfigInfo4TagCas() {
        ...
        MapperResult mapperResult = configInfoTagMapperByDM.updateConfigInfo4TagCas(context);
    ...
    public void testFindAllConfigInfoTagForDumpAllFetchRows() {
        MapperResult mapperResult = configInfoTagMapperByDM.findAllConfigInfoTagForDumpAllFetchRows(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testGetTableName() {
        String tableName = configInfoTagMapperByDM.getTableName();
        Assert.assertEquals(tableName, TableConstant.CONFIG_INFO_TAG);
    }
    
    @Test
    public void testGetDataSource() {
        String dataSource = configInfoTagMapperByDM.getDataSource();
