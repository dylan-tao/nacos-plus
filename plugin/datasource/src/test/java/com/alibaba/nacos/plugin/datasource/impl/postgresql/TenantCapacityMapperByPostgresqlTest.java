...
public class TenantCapacityMapperByPostgresqlTest {
    ...
    public void testIncrementUsageWithDefaultQuotaLimit() {
        MapperResult mapperResult = tenantCapacityMapperByPostgresql.incrementUsageWithDefaultQuotaLimit(context);
    ...
    public void testIncrementUsageWithQuotaLimit() {
        MapperResult mapperResult = tenantCapacityMapperByPostgresql.incrementUsageWithQuotaLimit(context);
        Assert.assertEquals(mapperResult.getSql(),
                "UPDATE tenant_capacity SET usage = usage + 1, gmt_modified = ? WHERE tenant_id = ? AND usage < "
                        + "quota AND quota != 0");
    ...
    public void testIncrementUsage() {
        MapperResult mapperResult = tenantCapacityMapperByPostgresql.incrementUsage(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testDecrementUsage() {
        MapperResult mapperResult = tenantCapacityMapperByPostgresql.decrementUsage(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testCorrectUsage() {
        MapperResult mapperResult = tenantCapacityMapperByPostgresql.correctUsage(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testGetCapacityList4CorrectUsage() {
        ...
        MapperResult mapperResult = tenantCapacityMapperByPostgresql.getCapacityList4CorrectUsage(context);
        Assert.assertEquals(mapperResult.getSql(), "SELECT id, tenant_id FROM tenant_capacity WHERE id>? OFFSET 0 LIMIT ?");
    ...
    public void testInsertTenantCapacity() {
        ...
        MapperResult mapperResult = tenantCapacityMapperByPostgresql.insertTenantCapacity(context);
        Assert.assertEquals(mapperResult.getSql(),
