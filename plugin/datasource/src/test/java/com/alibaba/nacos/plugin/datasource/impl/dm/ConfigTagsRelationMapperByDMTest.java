...
public class ConfigTagsRelationMapperByDMTest {
    ...
    private ConfigTagsRelationMapperByDM configTagsRelationMapperByDM;
    ...
    public void setUp() throws Exception {
        configTagsRelationMapperByDM = new ConfigTagsRelationMapperByDM();
    ...
    public void testFindConfigInfoLike4PageCountRows() {
        MapperResult mapperResult = configTagsRelationMapperByDM.findConfigInfoLike4PageCountRows(context);
    ...
    public void testFindConfigInfo4PageCountRows() {
        MapperResult mapperResult = configTagsRelationMapperByDM.findConfigInfo4PageCountRows(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testFindConfigInfo4PageFetchRows() {
        ...
        MapperResult mapperResult = configTagsRelationMapperByDM.findConfigInfo4PageFetchRows(context);
        Assert.assertEquals(
    ...
    public void tsetFindConfigInfoLike4PageFetchRows() {
        ...
        context.putWhereParameter(FieldConstant.APP_NAME, "AppName1");
        context.putWhereParameter(FieldConstant.CONTENT, "Content1");
        MapperResult mapperResult = configTagsRelationMapperByDM.findConfigInfoLike4PageFetchRows(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testGetTableName() {
        String tableName = configTagsRelationMapperByDM.getTableName();
        Assert.assertEquals(tableName, TableConstant.CONFIG_TAGS_RELATION);
    }
    
    @Test
    public void testGetDataSource() {
        String dataSource = configTagsRelationMapperByDM.getDataSource();
