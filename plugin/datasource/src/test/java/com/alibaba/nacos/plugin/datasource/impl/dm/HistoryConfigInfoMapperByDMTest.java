...
public class HistoryConfigInfoMapperByDMTest {
    ...
    private HistoryConfigInfoMapperByDM historyConfigInfoMapperByDM;
    ...
    public void setUp() throws Exception {
        historyConfigInfoMapperByDM = new HistoryConfigInfoMapperByDM();
    ...
    public void testRemoveConfigHistory() {
        MapperResult mapperResult = historyConfigInfoMapperByDM.removeConfigHistory(context);
    ...
    public void testFindConfigHistoryCountByTime() {
        MapperResult mapperResult = historyConfigInfoMapperByDM.findConfigHistoryCountByTime(context);
    ...
    public void testFindDeletedConfig() {
        MapperResult mapperResult = historyConfigInfoMapperByDM.findDeletedConfig(context);
    ...
    public void testFindConfigHistoryFetchRows() {
        ...
        context.putWhereParameter(FieldConstant.DATA_ID, dataId);
        MapperResult mapperResult = historyConfigInfoMapperByDM.findConfigHistoryFetchRows(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testDetailPreviousConfigHistory() {
        ...
        MapperResult mapperResult = historyConfigInfoMapperByDM.detailPreviousConfigHistory(context);
        Assert.assertEquals(mapperResult.getSql(),
    ...
    public void testGetTableName() {
        String tableName = historyConfigInfoMapperByDM.getTableName();
        Assert.assertEquals(tableName, TableConstant.HIS_CONFIG_INFO);
    }
    
    @Test
    public void testGetDataSource() {
        String dataSource = historyConfigInfoMapperByDM.getDataSource();
