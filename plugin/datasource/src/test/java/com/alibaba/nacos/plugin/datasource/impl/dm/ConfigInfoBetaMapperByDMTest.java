...
public class ConfigInfoBetaMapperByDMTest {
    ...
    private ConfigInfoBetaMapperByDM configInfoBetaMapperByDM;
    ...
    public void setUp() throws Exception {
        configInfoBetaMapperByDM = new ConfigInfoBetaMapperByDM();
    ...
    public void testUpdateConfigInfo4BetaCas() {
        ...
        MapperResult mapperResult = configInfoBetaMapperByDM.updateConfigInfo4BetaCas(context);
    ...
    public void testFindAllConfigInfoBetaForDumpAllFetchRows() {
        MapperResult result = configInfoBetaMapperByDM.findAllConfigInfoBetaForDumpAllFetchRows(context);
    ...
    public void testGetTableName() {
        String tableName = configInfoBetaMapperByDM.getTableName();
        Assert.assertEquals(tableName, TableConstant.CONFIG_INFO_BETA);
    }
    
    @Test
    public void testGetDataSource() {
        String dataSource = configInfoBetaMapperByDM.getDataSource();
